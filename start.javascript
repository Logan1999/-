...
Page({
  ...
  send: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=%E5%8C%97%E4%BA%AC&output=json&ak=', //百度天气API
      header: {
  ...
  getDataFromOneNet: function(){
    ...
    const requestTask = wx.request({
      url: 'https://api.heclouds.com/devices/20458570/datapoints?datastream_id=Light,Temperature,Humidity&limit=50',
      header: {
        'content-type': 'application/json',
        'api-key': ' Irkiil71AG=Q0iVhA97UHZmUcCg='
      },
      success: function (res) {
